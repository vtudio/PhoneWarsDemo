...
- (NSArray *) capabilityArray
{
	...
	if (flags & UIDeviceSupportsStillCamera) [array addObject:@"Still CCCamera"];
	if (flags & UIDeviceSupportsAutofocusCamera) [array addObject:@"AutoFocus CCCamera"];
	if (flags & UIDeviceSupportsVideoCamera) [array addObject:@"Video CCCamera"];
